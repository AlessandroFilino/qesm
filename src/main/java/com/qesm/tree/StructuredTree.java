...
import com.qesm.io.DotFileConverter;
...
public class StructuredTree<V extends AbstractProduct> implements DotFileConverter<STPNBlock> {
    ...
    public Activity buildAndConvertToActivity() {
        buildStructuredTree(false, false, null);
        StructuredTreeConverter treeConverter = new StructuredTreeConverter(structuredWorkflow);
        return treeConverter.convertToActivity();
    }
